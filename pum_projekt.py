...
data = pd.read_csv('/Users/maciejpazdecki/PycharmProjects/pythonProject9/PRSA_data_2010.1.1-2014.12.31.csv', sep = "," , encoding = 'utf-8')
...
sns.boxplot(x=pd.to_datetime(data['Timestamp']).dt.month
, y='pm2.5', data=data)
plt.xlabel('Miesiąc')
